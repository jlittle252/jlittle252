...
// Matches the expected token, reports an error if the token doesn't match
void match(int expectedToken, const string &expectedTokenName) {
    if (nextToken == expectedToken) {
        lex();
    } else {
        // When an error occurs, display the expected token name and the actual token name
...
// Function that immediately displays the error message and exits.
void error(const string &msg) {
